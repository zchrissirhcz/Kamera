================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : Detektor DCC Project Overview
===============================================================================

The application wizard has created this Detektor DCC application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your Detektor DCC application.
...
Detektor DCC.h
    ...
    CDetektorDCCApp application class.

Detektor DCC.cpp
    This is the main application source file that contains the application
    class CDetektorDCCApp.
...
res\Detektor DCC.ico
    This is an icon file, which is used as the application's icon.  This
    icon is included by the main resource file Detektor DCC.rc.
...
Detektor DCCDlg.h, Detektor DCCDlg.cpp - the dialog
    These files contain your CDetektorDCCDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's template is
    in Detektor DCC.rc, which can be edited in Microsoft Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CDetektorDCCDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named Detektor DCC.pch and a precompiled types file named StdAfx.obj.

Resource.h
    This is the standard header file, which defines new resource IDs.
    Microsoft Visual C++ reads and updates this file.

Detektor DCC.manifest
